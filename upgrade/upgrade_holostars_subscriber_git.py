...
def make_csv(tddir):
    global member_a
    global video
    fn='holostars_subscriber_before_sort' + d1 + 'data.csv'
    csv_dir=os.path.join('.\holostars_csv',d1)
...
#ビデオ投稿数とメンバーの名前の配列を統合
    ...
    fna='holostars_subscriber_after_sort' + d1 + 'data.csv'
    csv_dir=os.path.join('.\holostars_csv',d1)
